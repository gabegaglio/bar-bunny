...
in [`../CLAUDE.md`](../CLAUDE.md): dark, map-dominant, floating glass UI, no chrome.
...
3. Floating glassmorphic carousel at the bottom: bar name, rating, distance,
...
1. Tap a node → it animates to the **selected** state (enlarged, highlighted) and a
   glass preview appears.
...
1. Tap search → glass search modal.
